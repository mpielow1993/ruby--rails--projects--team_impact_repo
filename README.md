...
#Getting started as a member
  ...
  2. Logging in as an ordinary member:
  
    a. Go to the 'Log In' section in the navigation bar.
    b. Type your username and password, then click 'Log In'
  
  NOTE - There should already be data seeded within the database for this test design, so if you don't want to sign up as a new member you can use the following details 
         to log in.
...
#Member Capabilities
  ...
  7. Lessons
    ...
    b. Register for any lesson.
      ...
      NOTE - Before registering for a lesson, a membership subcription needs to be purchased within the store (see 'Order' below).
  ...
  9. Orders
    ...
    - Members can create, update and delete their own orders (constituting of OrderItems).
...
You can only register for a lesson if you have first purchased at least one membership. To do this, follow the steps below:
  ...
  4. Once you have purchased a membership (technically a subscription to a specific type of membership), you should observe the following:
